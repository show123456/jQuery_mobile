        ...
        <ul data-role="listview" class="ui-listview">
            ...
            <li data-role="collapsible" data-inset="false" data-iconpos="right">
                ...
                <ul data-role="listview" class="my-info-menu">   
                    ...
                    <li><a href="" data-ajax="false" class="ui-btn ui-btn-icon-right ui-icon-power menu-logout">&nbsp;&nbsp;- 로그아웃</a></li>
                </ul>    
            </li>
            <%}%>
            <li data-icon="home"><a href="/#main" class="ui-btn ui-btn-icon-right ui-icon-home  menu-main">홈</a></li>
            <li data-icon="search"><a href="/#search" class="ui-btn ui-btn-icon-right ui-icon-search menu-search">검색</a></li>
            <li data-icon="star"><a href="#" class="ui-btn ui-btn-icon-right ui-icon-star menu-favorite">즐겨찾기</a></li>
            <li data-icon="tag"><a data-ajax="false" href="/rank" class="ui-btn ui-btn-icon-right ui-icon-tag menu-ranking">전국 Top 10</a></li>
            <li data-icon="navigation"><a href="/#navigation" class="ui-btn ui-btn-icon-right ui-icon-navigation menu-navigation">위치정보</a></li>     
        </ul>
    </div>
